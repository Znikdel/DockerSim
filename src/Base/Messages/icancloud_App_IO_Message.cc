...
icancloud_App_IO_Message::icancloud_App_IO_Message(const char *name, int kind): icancloud_App_IO_Message_Base(name,kind){
...
icancloud_App_IO_Message::icancloud_App_IO_Message(const icancloud_App_IO_Message& other): icancloud_App_IO_Message_Base(other.getName()){
...
string icancloud_App_IO_Message::getIsPending_string(){
...
string icancloud_App_IO_Message::contentsToString (bool printContents){
...
void icancloud_App_IO_Message::parsimPack(cCommBuffer *b){
