...
icancloud_BlockList_Message::icancloud_BlockList_Message(const char *name, int kind): icancloud_BlockList_Message_Base(name,kind){
...
icancloud_BlockList_Message::icancloud_BlockList_Message(const icancloud_BlockList_Message& other): icancloud_BlockList_Message_Base(other.getName()){
...
void icancloud_BlockList_Message::updateLength (){
	...
	// Set the new size!
	this->setByteLength (newSize);
}


string icancloud_BlockList_Message::contentsToString (bool withBranches, bool printContents){
