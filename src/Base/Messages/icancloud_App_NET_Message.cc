...
icancloud_App_NET_Message::icancloud_App_NET_Message(const char *name, int kind): icancloud_App_NET_Message_Base(name,kind){
...
icancloud_App_NET_Message::icancloud_App_NET_Message(const icancloud_App_NET_Message& other): icancloud_App_NET_Message_Base(other.getName()){
...
string icancloud_App_NET_Message::contentsToString (bool printContents){
...
void icancloud_App_NET_Message::parsimPack(cCommBuffer *b){
