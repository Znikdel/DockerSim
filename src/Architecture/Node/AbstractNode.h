...
public:
    ...
    bool isON(){return (strcmp(getState().c_str(),MACHINE_STATE_OFF) != 0);};   // This method returns the state attribute
    bool isOFF(){return (strcmp(getState().c_str(),MACHINE_STATE_OFF) == 0);};   // This method returns the state attribute
    ...
    virtual void notifyManager(icancloud_Message* msg) = 0;
