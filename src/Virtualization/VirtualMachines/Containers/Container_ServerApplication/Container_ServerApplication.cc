...
#include "Container_ServerApplication.h"
#define INPUT_FILE "/web.html"
#define OUTPUT_FILE "/log.dat"
#define MAX_FILE_SIZE 2000000000
#define SM_WAIT_TO_EVENT  "Wait_To_Event"

Define_Module(Container_ServerApplication);



Container_ServerApplication::~Container_ServerApplication(){
}


void Container_ServerApplication::initialize(){
	...
	osStream << "Container_ServerApplication." << getId();
...
void Container_ServerApplication::startExecution (){
...
void Container_ServerApplication::finish(){
...
void Container_ServerApplication::processSelfMessage (cMessage *msg){
...
void Container_ServerApplication::processRequestMessage (icancloud_Message *sm){

}

void Container_ServerApplication::processResponseMessage (icancloud_Message *sm){
...
void Container_ServerApplication::changeState(string newState){

}


void Container_ServerApplication::newHit(){
    pendingHits++;
...
void Container_ServerApplication::serveWebCode(){
Enter_Method_Silent();
	// Reset timer!
	startServiceIO = simTime();
...
void Container_ServerApplication::executeCPUrequest(){
    Enter_Method_Silent();
...
void Container_ServerApplication::printResults (){
